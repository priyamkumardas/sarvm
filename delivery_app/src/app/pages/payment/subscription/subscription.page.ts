  ...
  constructor(private router: Router,
    ...
    private platform: Platform) { 
      ...
      /* this.platform.backButton.subscribeWithPriority(101, () => {
        ...
        if (this.router.url.toString().includes('subscription')) {
    ...
    getAllSubscription() {
      let entityId = this.commonService.userData.entityId;
      this.paymentService.getAllSubscriptions(entityId).subscribe((allSubscrip: any) => {
