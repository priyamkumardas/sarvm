...
export class ReferralService {
  ...
  Logisticsapplink='https://play.google.com/store/apps/details?id=com.sarvm.loga&hl=en-US&ah=uI6maScqUW8bclH7s_fV8-tJw58';
  ...
  Logistics_Message_BODY= `Hey! Check out SarvM.AI Logistics, an app digitizing the food supply chain. Download the app now  ${this.Logisticsapplink}. Give miss call at  ${environment.refferal.ackPhonenumber}  to acknowledge.`;
